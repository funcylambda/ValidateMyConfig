...
/* package validate-my-config-0.1.0.0 */
#ifndef VERSION_validate_my_config
#define VERSION_validate_my_config "0.1.0.0"
#endif /* VERSION_validate_my_config */
#ifndef MIN_VERSION_validate_my_config
#define MIN_VERSION_validate_my_config(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_validate_my_config */
...
#define CURRENT_COMPONENT_ID "validate-my-config-0.1.0.0-JBS27HBQZ4E5Sxco84jaDb-validate-my-config"
